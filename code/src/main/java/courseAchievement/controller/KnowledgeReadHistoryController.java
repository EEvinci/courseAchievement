...
//    }
    ...
    public ResponseData findReadHistoryByKnowledgeIid(@RequestBody Map temp){
        Page<KnowledgeReadHistoryEntity> knowledgeReadHistoryEntityPage = knowledgeReadHistoryService.findByKnowledgeIid((Integer) temp.get("knowledgeIid"),(Integer) temp.get("pageNum"),(Integer)temp.get("pageSize"));
        // 缺少一个错误处理
